 ...
 *
 * The icon is generated by app/icon.tsx — a 512px "SP" text mark, declared both
 * "any" and "maskable". Android crops maskable icons, which is why that file keeps
 * the glyph inside the central safe zone and paints the full canvas.
 */
